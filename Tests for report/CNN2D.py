...
class CNN2D(nn.Module):
    def __init__(self,img_width,pca_components,dropout_rate,kernel=1):
        ...
        self.conv1 = torch.nn.Conv2d(pca_components,SIZE1,kernel_size=kernel,padding='same') #[SIZE1, IMG_WIDTH, IMG_WIDTH]
        ...
        self.conv2 = torch.nn.Conv2d(SIZE1,SIZE2,kernel_size=kernel,padding='same')        #[SIZE2, IMG_WIDTH/2, IMG_WIDTH/2]
